...
for(i in 1:10){
    grid.raster(readPNG(paste0('D:/DataSci_tools/Git_Repo/dota2/59x33/',p1_data$name[i],'_sb.png')),x=i/12,height=.1)
}
```

```{r,fig.height=4,fig.width=10,echo=FALSE}
for(i in 20:11){
    grid.raster(readPNG(paste0('D:/DataSci_tools/Git_Repo/dota2/59x33/',p1_data$name[i],'_sb.png')),x=(21-i)/12,height=.1)
}
```
